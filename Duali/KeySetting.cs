        ...
        public string ToHexString()
        {
            ...
            switch (access)
            {
                ...
                case ChangeKeyAccess.SPECIFY_KEY:
                    setting += DataUtils.DecToBin(specifyKey);
                    break;
            ...
            setting += rfu;
            setting += DataUtils.DecToBin(numOfKey);
            return DataUtils.BinaryStringToHexString(setting);
        }

        public KeySetting(String hex)
        {
            String bin = DataUtils.HexToBin(hex);
            ...
            switch(access)
            {
                ...
                default:
                    ...
                    this.specifyKey = DataUtils.BinToDec(access);
                    break;
            }
            ...
            this.numOfKey = DataUtils.BinToDec(numOfKey);
        }
